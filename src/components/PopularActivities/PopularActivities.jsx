...
const PopularActivities = () => {
  const items = [
    { id: 1, name: "Trekking", imgPath: "TrekkingPopular.png", trips:7 },
    { id: 2, name: "Camping", imgPath: "CampingPopular.png", trips:3 },
    { id: 3, name: "Adventure Activities", imgPath: "AdventurePopular.png", trips:5 },
    { id: 4, name: "Nature Education", imgPath: "NatureEdPopular.png", trips:1 },
  ];
        ...
        {items.map((item) => (
          ...
          >
            <div className="absolute top-0 right-0 px-8 py-3 bg-[#A5F211] rounded-tr-3xl flex justify-center items-center">
              <p className="font-[manrope] text-md 2xl:text-xl">{`${item.trips} ${item.trips ===1 ? "Trip":"Trips"}`}</p>
            </div>
